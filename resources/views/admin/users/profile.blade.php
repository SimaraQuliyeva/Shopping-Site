...
@section('content')
    ...
    {{--   @extends('admin.header2')--}}
    <div class="card shadow-lg mx-4 card-profile-bottom">
        <div class="card-body p-3">
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="{{ asset('storage/' .$user->remember_token)}}" alt='profile_image' class='w-100 border-radius-lg shadow-sm'>
                    </div>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="file" value="" name="imageFile">
                                    </div>
